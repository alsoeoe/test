...
async function TotalPageViews() {
    ...
    return (
        <span
            className="flex items-center justify-center gap-1 text-xs text-zinc-500 dark:text-zinc-400 md:justify-start">
...
export async function Footer() {
    const {
        ...
        sql`SELECT (SELECT COUNT(*) FROM subscribers WHERE subscribed_at IS NOT NULL) as subscribers`
    )
